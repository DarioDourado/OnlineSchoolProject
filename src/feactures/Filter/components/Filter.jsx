...
export default function Filter() {
  return (
    <section className='filterComponent flex container mx-auto max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl md:flex-row md:max-w-scree-md md:flex-nowrap justify-center'>
