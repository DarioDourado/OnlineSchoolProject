    ...
    <section className='container mx-auto max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl'>
        <section className='flex items-start justify-between p-3'>
            <section className='logo'>
                ...
                <h3 className='text-sm'>Os seu objectivos, serão os nossos</h3>
            </section>
            <section>
                <h2>Links Rápidos</h2>
                <article className='flex gap-5 justify-center'>
                    <div className='flex flex-col gap-1'>
                        <h3 className='text-sm lg:text-lg'>Acerca</h3>
                        <h3 className='text-sm lg:text-lg'>Cursos</h3>
                    </div>
                    <div className='flex flex-col gap-1'>
                        <h3 className='text-sm lg:text-lg'>Trabalhe connosco</h3>
                        <h3 className='text-sm lg:text-lg'>Contactos</h3>
                    </div>
                </article>
            </section>
            <section>
